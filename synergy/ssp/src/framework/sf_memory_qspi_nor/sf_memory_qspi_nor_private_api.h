...
#ifndef SF_MEMORY_QSPI_NOR_PRIVATE_API_H
#define SF_MEMORY_QSPI_NOR_PRIVATE_API_H
...
ssp_err_t SF_MEMORY_QSPI_NOR_Erase      (sf_memory_ctrl_t      * const p_ctrl,
                                         uint32_t                const memory_address,
                                         uint32_t                const num_bytes);
...
#endif /* SF_MEMORY_QSPI_NOR_PRIVATE_API_H */
